...
export const sortEvents = (events, sortBy) => {
    ...
    switch (sortBy) {
        ...
        case 'price-low':
            return sortedEvents.sort((a, b) => (parseFloat(a.price) || 0) - (parseFloat(b.price) || 0));
        case 'price-high':
            return sortedEvents.sort((a, b) => (parseFloat(b.price) || 0) - (parseFloat(a.price) || 0));
        case 'alphabetical':
            return sortedEvents.sort((a, b) => a.title.localeCompare(b.title));
        case 'views':
            return sortedEvents.sort((a, b) => (b.views?.length || 0) - (a.views?.length || 0));
        case 'popular':
        default:
            return sortedEvents.sort((a, b) => (b.likes?.length || 0) - (a.likes?.length || 0));
    }
};
